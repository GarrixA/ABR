...
const MccSideBar = () => {
  ...
  return (
    <div className="wrapper flex relative">
      {/* left side */}
      <div className="leftSide w-[20%] h-screen flex-col  fixed left-0 shadow-xl bg-[#009048] md:flex hidden">
      ...
      {/* Right side */}
      <div className="rightSide h-screen absolute md:w-[80%] w-full md:right-0">
